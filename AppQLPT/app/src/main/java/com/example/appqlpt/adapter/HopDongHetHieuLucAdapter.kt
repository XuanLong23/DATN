...
import com.example.appqlpt.databinding.DialogChiTietHopDong2Binding
...
class HopDongHetHieuLucViewHolder(
    ...
    fun bind(hopDong: HopDong){
        ...
        binding.tvChiTietDanhSachHD.setOnClickListener {
            ...
            dialog.tvTenChuHopDong.setText(""+ HopDongDao(binding.root.context).getTenKhachThueByIDHopDong(hopDong.ma_hop_dong))
